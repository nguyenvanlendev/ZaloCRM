...
export const SETTINGS_GROUPS: SettingsGroup[] = [
  ...
  // Gộp "Thông báo hệ thống" (từ Tổ chức cũ) + "Trợ lý AI" (từ CRM cũ) + Dev/API.
  {
    ...
    items: [
      ...
      { id: 'templates', label: 'Mẫu tin nhắn', icon: 'mdi-message-text-outline', route: '/settings/crm/templates', permission: 'everyone', aliases: ['mẫu tin nhắn', 'tin nhắn nhanh', 'template', 'shortcut'] },
      ...
      { id: 'knowledge-base', label: 'GraphRAG Knowledge', icon: 'mdi-graph', route: '/settings/crm/knowledge-base', permission: 'admin', resource: 'settings' },
