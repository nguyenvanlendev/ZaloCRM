  ...
  <div class="media-page">
    ...
    <header class="m-top">
      ...
      <div class="m-tools">
        <div class="m-search">
          <span class="i">🔍</span>
          <input v-model="search" placeholder="Tìm ảnh, tag khóa học…" @input="debouncedReload" />
        </div>
...
.btn-trash:hover { border-color:var(--brand, #e11d48); color:var(--brand, #e11d48); }
.btn-trash.on { background:var(--brand, #e11d48); border-color:var(--brand, #e11d48); color:#fff; }
...
.t-restore { flex:1; display:inline-flex; align-items:center; justify-content:center; gap:4px; background:var(--brand-soft, #ffe4e6); color:var(--brand, #e11d48); border:1px solid var(--brand-soft, #ffe4e6); border-radius:var(--r-sm); padding:5px 8px; font-size:11.5px; font-weight:600; cursor:pointer; }
.t-restore:hover { background:var(--brand, #e11d48); color:#fff; border-color:var(--brand, #e11d48); }
...
.btn-multi:hover { border-color:var(--brand, #e11d48); color:var(--brand, #e11d48); }
.btn-multi.on { background:var(--brand, #e11d48); border-color:var(--brand, #e11d48); color:#fff; }
...
.pick-tick.on { background:var(--brand, #e11d48); }
.card.picked { border-color:var(--brand, #e11d48); box-shadow:0 0 0 2px rgba(225, 29, 72, 0.2); }
.bulk-bar { display:flex; align-items:center; gap:10px; background:var(--brand-soft, #ffe4e6); border:1px solid rgba(225, 29, 72, 0.15); border-radius:var(--r-md); padding:9px 13px; margin-bottom:14px; }
.bulk-cnt { font-size:13px; font-weight:700; color:var(--brand-700, #9f1239); flex-shrink:0; }
.bulk-sel, .bulk-tag { border:1px solid var(--line, #e2e8f0); border-radius:var(--r-sm); padding:6px 10px; font-size:12.5px; background:#fff; color:var(--ink); outline:none; }
...
.bulk-clear { margin-left:auto; background:none; border:none; color:var(--brand-700, #9f1239); font-size:12.5px; font-weight:600; cursor:pointer; }
</style>
