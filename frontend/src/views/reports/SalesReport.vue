...
const AV_COLORS = [
  '#e11d48', '#7a4fb0', '#b0734f', '#4fb09a', '#b04f6e',
...
.usage-divider { display: flex; align-items: center; gap: 8px; font-size: 15px; font-weight: 700;
  color: var(--rk-brand-700, #9f1239); margin: 20px 0 14px; padding-top: 14px; border-top: 1px dashed var(--rk-hairline, #e6e9ef); }
.usage-divider :deep(.v-icon) { color: var(--rk-brand, #e11d48); }
...
.hh-c.hl0 { background: #eef1f6; } .hh-c.hl1 { background: #ffe4e6; } .hh-c.hl2 { background: #fecdd3; }
.hh-c.hl3 { background: #fb7185; } .hh-c.hl4 { background: var(--rk-brand, #e11d48); }
...
.fn-sw.s0 { background: var(--rk-brand-700, #9f1239); } .fn-sw.s1 { background: var(--rk-brand, #e11d48); }
.fn-sw.s2 { background: #fb7185; } .fn-sw.s3 { background: #fecdd3; }
...
.fn-seg.s0 { background: var(--rk-brand-700, #9f1239); } .fn-seg.s1 { background: var(--rk-brand, #e11d48); }
.fn-seg.s2 { background: #fb7185; } .fn-seg.s3 { background: #fecdd3; color: var(--rk-brand-700, #9f1239); }
</style>
